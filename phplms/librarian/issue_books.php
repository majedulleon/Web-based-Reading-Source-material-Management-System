                        ...
                        <div class="x_content">
                            <form name="form1" action="" method="post">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="submit" value="Search" name="submit1" class="form-control btn btn-dark"
                            ...
                            if (isset($_POST["submit1"]))
                            {
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="submit" value="Issue Books" name="submit2" class="form-control btn btn-dark"
                                                   style="margin-top: 5px;">
                                        </td>
                                    </tr>
                    ...
                    if (isset($_POST["submit2"]))
                    {
                        ...
                        if($qty==0)
                        {
                            ...
                            <div class="alert alert-danger col-lg-6 col-lg-push-3">
                                <strong style="color:white">Book Not Available at this Moment</strong>
                            </div>
                        <?php
                        }
                        else
