        ...
        <div class="">
            ...
            <div class="row" style="min-height:500px">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Book Details With Students</h2>
                        ...
                        <div class="x_content">
                                ...
                                while ($row=mysqli_fetch_array($res))
                                {
                                    ...
                                    echo "<br>";
                                    ?> <a href="all_student_of_this_books.php?books_name=<?php echo $row["books_name"]; ?>" style="color: #90111A">Student Record if this books</a> <?php
                                    echo "</td>";
